  ...
  <i class="icon-shopping-cart"></i> Sepetim  <?php
   ...
   <div class="dropdown-menu"style="background:white " aria-labelledby="dropdownMenuButton">
    ...
    <tr>
		...
		<?php
	 /*** verileri çekme ***/
	$hediyekutu=$baglanti->query("SELECT * FROM hediyekutu");
          ...
          <div class="span12">
            <div class="inner-heading">
              <ul class="breadcrumb">
                ...
                <li class="active">Hediye Kutularımız</li>
              </ul>
              <h2>HEDİYE KUTULARIMIZ <br>
      ...
      <div class="container">
        <div class="row">
          <div class="span12">
            ...
            <div class="row">
			<?php foreach($hediyekutu as $hdkutu)
			{
?>
                ...
                <ul id="thumbs" class="team">
				 <li class="item-thumbs span3 dev" data-id="id-1" data-type="dev">
                    <div class="team-box thumbnail">
                      <form method="post" action="hediyekutu.php?action=add&id=<?php echo $hdkutu["id"]; ?>">

                      <img src ="image/yenikutular/<?php echo $hdkutu["img_url"];?>" alt="<?php echo $hdkutu["hd_adi"];?>" >

                      <div class="caption">
                        <h5><?php echo $hdkutu["hd_adi"];

						?></h5><br>

						<p>
                         <?php echo $hdkutu["hd_detay"]; ?>
                        </p>
						  <input type="text" class="form-control sekil"name="quantity" value="1" />
						<p>
                          <strong><?php echo $hdkutu["hd_fiyat"]; ?></strong>  TL
                        </p>
						           <input type="hidden" name="hidden_name" value="<?php echo $hdkutu["hd_adi"]; ?>" />
                       <input type="hidden" name="hidden_price" value="<?php echo $hdkutu["hd_fiyat"]; ?>" />
                      ...
                      <form method="post" action="incele.php?id=<?php echo $hdkutu["id"]; ?> ">
                        <button type="submit" class="btn sag wdh" >
                          <i class="icon-circle-arrow-right "></i> Kutu İçeriği
                      </button>
</form>
                    </div>
