  ...
  <i class="icon-shopping-cart"></i> Sepetim  <?php
   ...
   <div class="dropdown-menu"style="background:white " aria-labelledby="dropdownMenuButton">
	...
	?>
			  <div class="kare" >
			  <br>
                  <div class="span4 cizgi">
                    <div class="tab-pane" id="uye">
                      <ul class="popular">
					    <h6 style="color:red">Üyelik Bilgilerim</h6>
                          <form id="commentform" action="#" method="post" name="comment-form" class="orta" >
                <div class="row">
...
?>
				 <div class="span2">
				  ...
				  <div class="span2">
                    <input type="text"name="ad" value="<?=$k["ad"]?>" />
				 ...
				 <div class="span2">
				  ...
				  <div class="span2">
                    <input type="text"name="soyad" value="<?=$k["soyad"]?>" />
					  </div>
					 <div class="span2">
		          <p> &nbsp;&nbsp;* Kullanıcı Adı :  </p>
				  </div>
				    <div class="span2">
					 ...
					 <input type="text" name="kullanici_adi" value="<?=$k["kullanici_adi"]?>"/>
                  </div>
		          ...
		          <p> &nbsp;&nbsp;* E-Posta :  </p>
				    ...
				    <div class="span2">
					 ...
					 <input type="text" name="kullanici_eposta" value="<?=$k["kullanici_eposta"]?>"/>
                  </div>
		          ...
		          <p> &nbsp;&nbsp;* Telefon No :  </p>
				    ...
				    <div class="span2">
					 ...
					 <input type="text" name="kullanici_telefonNo" value="<?=$k["kullanici_telefonNo"]?>"/>
                  </div>
                   <div class="span2 pull-right">
                    <button class="btn btn-theme btn-medium margintop10" type="submit" name="guncelle">Güncelle</button>
                  </div>
				  <?php
			}?>
			...
			if(isset($_POST["guncelle"])){
				...
				$sorgu="UPDATE `kullanici` SET `ad`='".$_POST['ad']."',`soyad`='".$_POST["soyad"]."',
				`kullanici_adi`='".$_POST['kullanici_adi']."',
				`kullanici_eposta`='".$_POST['kullanici_eposta']."',
				`kullanici_telefonNo`='".$_POST['kullanici_telefonNo']."'
				WHERE `kullanici`.`kullanici_id`=".$a;
				$baglanti->query($sorgu);

			}
			if(isset($_POST["paylas"])){

				$sorgu="UPDATE `kullanici` SET `kullanici_sifre`='".$_POST['yeni']."'
				WHERE `kullanici`.`kullanici_id`=".$a;
				$baglanti->query($sorgu);
  ...
  <div class="tab-pane active" id="one">
                      <ul class="popular">
					  <h6 style="color:red">Şifre Güncelleme</h6>
                          <form id="commentform" action="#" method="post" name="comment-form" class="orta" >
                <div class="row">
						<?php foreach($kullanici as $k)
			{
?>
				  ...
				  <div class="span2">
                    <input type="text"name="kt_adi" value="<?=$k["kullanici_sifre"]?>" />
					  </div>
					 <div class="span2">
		          <p> &nbsp;&nbsp;* Yeni Şifre :  </p>
				  </div>
		          ...
		          <p> &nbsp;&nbsp;* Yeni Şifre (Tekrar) :  </p>
				    ...
				    <div class="span2">
					 ...
					 <input type="text" name="yeni_tekrar"/>
                  </div>
			 <div class="span2 pull-right">
                    <button class="btn btn-theme btn-medium margintop10" type="submit" name="paylas">Güncelle</button>
                  </div>
                </div>
              </form>
			  <?php
